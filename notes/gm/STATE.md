...
What is advancing offscreen, and how far along. A clock is the honest way to
hold tension across scenes without resolving it, and the thing to tick when the
player stalls rather than forcing them to choose.
...
Rules calls made where the system was silent or unclear. Once made, they hold —
a ruling that drifts between sessions is worse than either version applied
consistently.
...
outside the Empire belongs entirely to the finder, while anything recovered inside
is split half to the Empire or landowner. So every find made in that strip has been
taxed at half by a man whose commission expired three years ago. Destrio Mennicus
has paid it four times this year and thinks he is merely being gouged.

**Quellus's own belief:** that he *restored* a boundary the Empire had let slip.
He has never checked. He is wrong. This must not be softened into being secretly
right — but he must also never be written as knowingly corrupt, because the
campaign's whole question is what Lawfulness costs when the law stops arriving.
